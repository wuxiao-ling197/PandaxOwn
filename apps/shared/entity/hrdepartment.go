...
type ResCompanyB struct {
	ID          int64          `gorm:"primaryKey;column:id;default:nextval(res_company_id_seq::regclass);NOT NULL" json:"id,omitempty"`
...
type HrDepartment struct {
	...
	Children           []HrDepartment `gorm:"foreignKey:ParentId;references:ID" json:"children,omitempty"`
...
func (ResCompanyB) TableName() string {
	return "res_company" // 确保预加载preload时的表名正确
}
